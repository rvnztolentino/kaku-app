  ...
  return (
    <>
      <div className="fade-in-1 flex flex-col justify-center items-center min-h-screen font-noto-sans py-10 xs:mt-[-40px] lg:mt-[-40px]">
        ...
        <p className="fade-in-1 text-5xl text-dark-gray font-playfair-display text-center mt-2 xs:mx-20 lg:mx-96 2xl:mx-96">Plan your tasks. Simplify your day. Get more done.</p>
