  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center min-h-screen font-noto-sans py-10 mt-[35px]">
        ...
        <p className="xs:w-4/5 lg:w-1/3 5xl:w-1/4 px-2 mt-2 mb-2 text-md text-dark-gray xs:text-center lg:text-left">Have any questions? <br></br>Feel free to reach out to us, and we will get back to you shortly.</p>
        <iframe
          ...
          title="Tally Form"
          allowFullScreen
          className="xs:w-auto lg:w-1/3 5xl:w-1/4">
        </iframe>
      </div>
    </>
  );
