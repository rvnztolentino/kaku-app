...
const About = () => {
    return (
    <>
    <div className="flex flex-col justify-center items-center min-h-screen font-noto-sans mt-[-80px] xs:mt-[40px] sm:mt-[0px] lg:mt-[20px]">
        <h1 className="text-4xl text-dark-gray font-playfair-display">About《 kaku 》</h1>
        <p className="text-md text-dark-gray mt-10 mx-144 xs:mx-20 lg:mx-96 2xl:mx-128 5xl:mx-144">
