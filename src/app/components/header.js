...
const Header = () => (
  <header className="sticky text-gray bg-white top-0 left-0 right-0 z-50 p-5 border-b border-slate-300">
    <div className="flex justify-between items-center">
      ...
      <nav>
        <ul className="flex space-x-4">
          ...
          <p>//</p>
          <Link href="/blog"><button className="hover:text-red-200">blog</button></Link>
        </ul>
      </nav>
  </div>
  </header>
